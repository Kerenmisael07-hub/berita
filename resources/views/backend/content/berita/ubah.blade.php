            ...
            <div class="card-body">
                <form action="{{ route('berita.prosesUbah') }}" method="post" enctype="multipart/form-data">
                        ...
                        <select name="id_kategori" class="form-control @error('id_kategori') is-invalid @enderror">
                            ...
                            @foreach($kategori as $row)
                               {{-- @php
                                ...
                                <option value="{{ $row->id_kategori }}" {{ old('id_kategori', $berita->id_kategori) == $row->id_kategori ? 'selected' : '' }}>
                                    {{ $row->nama_kategori }}
                                </option>
                            @endforeach
                        </select>
                    ...
                    <div class="mb-3">
                        ...
                        @enderror
                        <div class="mt-2">
                            <img id="tampilFoto" onerror="this.onerror=null;this.src='https://t4.ftcdn.net/jpg/04/73/25/49/360_F_473254957_bxG9yf4ly70B05I0O5KABlN930GwaMQz.jpg';" src="{{ asset('storage/berita/' . $berita->gambar_berita) }}"alt="Preview" width="15%">
                        </div>
                    </div>
